...
using CleanWebApiTemplate.Application.Features.Auth.Commands.ForgotPassword;
using CleanWebApiTemplate.Application.Features.Auth.Commands.GetExternalLoginTokens;
using CleanWebApiTemplate.Application.Features.Auth.Commands.Login;
using CleanWebApiTemplate.Application.Features.Auth.Commands.RefreshToken;
using CleanWebApiTemplate.Application.Features.Auth.Commands.Register;
using CleanWebApiTemplate.Application.Features.Auth.Commands.ResendConfirmationEmail;
using CleanWebApiTemplate.Application.Features.Auth.Commands.ResetPassword;
using CleanWebApiTemplate.Application.Features.Auth.Commands.RevokeRefreshToken;
